...
class RestaurantOrderManagement:
    ...
    def setup_background(self, root):
        ...
        if os.path.exists(bg_path):
            try:
                if HAS_PIL:
                    pil_img = Image.open(bg_path).resize((bg_width, bg_height), Image.Resampling.LANCZOS)
                    background_image = ImageTk.PhotoImage(pil_img)
                else:
        ...
        canvas.create_rectangle(0, 0, bg_width, bg_height, fill="#f4f4f9", outline="")
